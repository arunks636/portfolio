...
function Contact({ setCursorVariant }) {
  ...
  return (
    <div className="dark:bg-stone-50 bg-dark dark:text-black text-white  pb-20 pt-10 px-[20px]" id="contactSection">
      <div className="container mx-auto py-5 relative">
        <span
          className="absolute pointer-events-none right-0 top-[-20px] lg:top-5 lg:w-[200px] lg:h-[200px] w-[100px] h-[100px] rounded-full bg-theme-yellow flex items-center justify-center font-display lg:text-3xl text-[15px] text-black dark:opacity-100 opacity-50 lg:opacity-100 z-0">
          Get in touch
        </span>
